![Demonstration:](https://github.com/sigson/UTanks/blob/master/preview.gif?raw=true) <br />
...
Briefly about the project - the ECS pattern is used as the basis for the architecture of client-server interaction (we can watch my pure ECS realization on https://github.com/sigson/NECS), which I wrote from scratch to implement the tasks I needed. <br />
