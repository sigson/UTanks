...
namespace SecuredSpace.AudioManager.Core {
    /// <summary>
    ...
    public interface IAudioManager {
        ...
        public AudioError Fade(string name, ChildType child = Constants.DEFAULT_CHILD_TYPE);
        public AudioError FadeAll(List<string> excludeList = null, ChildType child = Constants.DEFAULT_CHILD_TYPE);

        public void UpdateSettings();

        public void DestroyCleanup();
        public AudioError PlayBlock(List<string> names, ChildType child = Constants.DEFAULT_CHILD_TYPE);

        public AudioError PlayWithSettings(string name, float timeOffset, ChildType child = Constants.DEFAULT_CHILD_TYPE);
        ...
        public AudioError StopAll(ChildType child = Constants.DEFAULT_CHILD_TYPE);

        public AudioError SoftStop(string name, bool unloop = false, ChildType child = Constants.DEFAULT_CHILD_TYPE);

        public AudioError SoftStopAll(bool unloop = false, ChildType child = Constants.DEFAULT_CHILD_TYPE);
