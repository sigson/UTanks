...
using SecuredSpace.Common.Animation;
...
namespace SecuredSpace.AudioManager.Core {
    ...
    public class AudioSourceWrapper {
        ...
        public AudioSourceSetting AudioSourceSettingCache;
        public AudioAnchor audioAnchor;
        ...
        public void DestroyCleanup()
        {
            ...
            UnityEngine.Object.Destroy(m_wrappedSource);
            m_childrenDictionary.ForEach(x =>
            {
                x.Value.Stop();
        ...
        {
            //m_wrappedSource.mute = false;
            inFade = false;
            this.MaxDistance = AudioSourceSettingCache.maxDistance;
            this.Loop = AudioSourceSettingCache.loop;
            this.MinDistance = AudioSourceSettingCache.minDistance;
            this.SpatialBlend = AudioSourceSettingCache.spatialBlend;
            //audioSource.spread = AudioSourceSettingCache.spreadAngle;
            this.Pitch = AudioSourceSettingCache.pitch;
            this.DopplerLevel = AudioSourceSettingCache.dopplerLevel;
            TweenerService.instance.ExcludeObjectImmediate(m_wrappedSource);
        }
        ...
        {
            inFade = true;
            m_wrappedSource.DOFade(0, 0.03f, ()=>
            {
                //m_wrappedSource.mute = true;
                if(inFade)
                    m_wrappedSource.Stop();
                if(audioAnchor != null)
                    m_wrappedSource.volume = audioAnchor.volume;
            });
        }
