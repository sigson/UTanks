...
namespace SecuredSpace.AudioManager.Settings {
    ...
    public class AudioSourceSetting : ScriptableObject {
        ...
        public bool relativityOfTimeValues = true;
        ...
        public AudioSourceSetting UpdateSettings(string name, bool Loop, float spatialBlend = 0f)
        {
            this.soundName = name;
            this.loop = Loop;
