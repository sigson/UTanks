...
namespace SecuredSpace.Effects
{
	...
	public partial class LightShafts : MonoBehaviour
	{
		...
		void RenderInterpolationTexture(Vector4 lightPos)
		{
			...
			if (!m_DX11Support && (Application.platform == RuntimePlatform.WindowsEditor || Application.platform == RuntimePlatform.WindowsPlayer || Application.platform == RuntimePlatform.WebGLPlayer))
			{
