...
Shader "GlobalSnow/Excluded Terrain/Diffuse" {
    Properties {
...
Stencil {
    ...
    Dependency "AddPassShader"    = "GlobalSnow/Excluded Terrain/Diffuse-AddPass"
    Dependency "BaseMapShader"    = "GlobalSnow/Excluded Terrain/Diffuse-Base"
    Dependency "BaseMapGenShader" = "GlobalSnow/Excluded Terrain/Diffuse-BaseGen"
