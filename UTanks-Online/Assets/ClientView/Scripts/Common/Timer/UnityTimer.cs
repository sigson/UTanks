...
/// </summary>
namespace SecuredSpace.UnityExtend.Timer
{
    public class UnityTimer
    {
        ...
        public static UnityTimer Register(float duration, Action onComplete, List<Action<float>> onUpdate = null,
            bool isLooped = false, bool useRealTime = false, MonoBehaviour autoDestroyOwner = null)
        {
            ...
            if (UnityTimer._manager == null)
            {
                ...
                else
                {
                    ...
                    UnityEngine.MonoBehaviour.DontDestroyOnLoad(managerObject);
                }
            }
        ...
        private readonly List<Action<float>> _onUpdate;
        ...
        private UnityTimer(float duration, Action onComplete, List<Action<float>> onUpdate,
        ...
        private void Update()
        {
            ...
            {
                this._onUpdate.ForEach(x => x(this.GetTimeElapsed()));
            }
        ...
        /// <summary>
        /// Manages updating all the <see cref="UnityTimer"/>s that are running in the application.
        /// This will be instantiated the first time you create a timer -- you do not need to add it into the
        /// scene manually.
        /// </summary>
        private class TimerManager : MonoBehaviour
        {
            private List<UnityTimer> _timers = new List<UnityTimer>();

            // buffer adding timers so we don't edit a collection during iteration
            private List<UnityTimer> _timersToAdd = new List<UnityTimer>();

            public void RegisterTimer(UnityTimer timer)
            {
            ...
            {
                foreach (UnityTimer timer in this._timers)
                {
                    timer.Cancel();
                }

                this._timers = new List<UnityTimer>();
                this._timersToAdd = new List<UnityTimer>();
            }
    ...
    public static class TimerExtensions
    {
        ...
        public static UnityTimer AttachTimer(this MonoBehaviour behaviour, float duration, Action onComplete,
            List<Action<float>> onUpdate = null, bool isLooped = false, bool useRealTime = false)
        {
            return UnityTimer.Register(duration, onComplete, onUpdate, isLooped, useRealTime, behaviour);
        }
    }
}
