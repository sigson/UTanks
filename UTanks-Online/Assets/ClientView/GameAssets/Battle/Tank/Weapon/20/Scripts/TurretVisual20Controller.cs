...
{
    public class TurretVisual20Controller : ITurretVisualController
    {
        public override void BuildVisual(VisualizableEquipment visualizableEquipment, ItemCard eraItemCard)
        {
            TurretVisualDefaultController.BuildVisualShared<TurretVisual20Controller>(visualizableEquipment, eraItemCard, this);
        }
