...
namespace UnityTemplateProjects
{
    public class SimpleCameraController : MonoBehaviour
    {
...
#else
            return !ClientInitService.instance.LockInput ? Input.mouseScrollDelta.y * 0.2f : 0f;
#endif
        }
...
#else
            return !ClientInitService.instance.LockInput ? new Vector2(Input.GetAxis("Mouse X"), Input.GetAxis("Mouse Y")) * 10 : Vector2.zero;
#endif
        }
        ...
        bool IsBoostPressed()
        {
            ...
            return boost;
#else
            return !ClientInitService.instance.LockInput ? Input.GetKey(KeyCode.LeftShift) : false;
#endif
...
#else
            return !ClientInitService.instance.LockInput ? Input.GetKey(KeyCode.Escape) : false;
#endif
        }
        ...
        bool IsCameraRotationAllowed()
        {
            ...
            return canRotate;
#else
            return !ClientInitService.instance.LockInput ? Input.GetMouseButton(1) : false;
#endif
        }
...
#else
            return !ClientInitService.instance.LockInput ? Input.GetMouseButtonDown(1) : false;
#endif
        }
        ...
        bool IsRightMouseButtonUp()
        {
            ...
            return Mouse.current != null ? !Mouse.current.rightButton.isPressed : false;
#else
            return !ClientInitService.instance.LockInput ? Input.GetMouseButtonUp(1) : false;
#endif
        }
