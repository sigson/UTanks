...
namespace UTanksClient.Extensions {
  public static class FileInfoExtensions {
        ...
        {
            //await
            using FileStream sourceStream = source.CreateStream(FileMode.Open, FileAccess.Read, FileShare.Read);
            using FileStream destinationStream = destination.CreateStream(FileMode.Create, FileAccess.Write, FileShare.None);
    ...
    public static async Task<MemoryStream> ReadAsync(this FileInfo file) {
            //await
      using FileStream stream = file.CreateStream(FileMode.Open, FileAccess.Read, FileShare.Read);
    ...
    public static async Task WriteAsync(this FileInfo file, MemoryStream stream) {
      using FileStream fileStream = file.CreateStream(FileMode.Create, FileAccess.Write);
